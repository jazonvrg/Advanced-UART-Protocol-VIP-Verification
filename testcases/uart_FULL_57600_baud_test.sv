class uart_FULL_57600_baud_test extends uart_base_test;
	`uvm_component_utils(uart_FULL_57600_baud_test)
	...
	function new(string name = "uart_FULL_57600_baud_test", uvm_component parent);
...
endclass: uart_FULL_57600_baud_test
