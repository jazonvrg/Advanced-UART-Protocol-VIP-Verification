class uart_HALF_2_stop_bit_test extends uart_base_test;
	`uvm_component_utils(uart_HALF_2_stop_bit_test)

	uart_sequence lhs_seq, rhs_seq;
	time baud_period;

	function new(string name = "uart_HALF_2_stop_bit_test", uvm_component parent);
	...
	virtual task run_phase(uvm_phase phase);
		...
		repeat (256) begin
			...
			if (cfg_lhs.randomize() with {num_of_stop_bit == 2;}) begin
...
endclass: uart_HALF_2_stop_bit_test
