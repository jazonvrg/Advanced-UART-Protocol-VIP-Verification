class uart_HALF_8bit_data_test extends uart_base_test;
	`uvm_component_utils(uart_HALF_8bit_data_test)
	...
	function new(string name = "uart_HALF_8bit_data_test", uvm_component parent);
...
endclass: uart_HALF_8bit_data_test
